...
export default function Sidebar() {
    ...
    return (
        <box><Drawer variant="permanent" open={open}>
        <DrawerHeader>
        ...
        <Divider />
        {/* <List>
          {['Item 1', 'Item 2', 'client', 'Items 4'].map((text, index) => (
                ...
                <>
                  ...
                  <Collapse in={openDrop} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                      <ListItemButton component={Link} to="/new-user" sx={{ pl: 4 }}>
                        <ListItemIcon>
                          <InboxIcon />
                        </ListItemIcon>
                        <ListItemText primary="New User" />
                      </ListItemButton>
                      <ListItemButton component={Link} to="/list-of-users" sx={{ pl: 4 }}>
                        <ListItemIcon>
                          <MailIcon />
                        </ListItemIcon>
